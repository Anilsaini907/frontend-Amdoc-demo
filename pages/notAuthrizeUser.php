...
<link rel="stylesheet" href="http://localhost/skydash/css/notauth.css">
</head>
                    ...
                    <div class="col-lg-7 mx-auto text-white">
                        ...
                        <div class="row mt-5">
                            <div class="col-12 text-center mt-xl-2">
                                <a class="text-white font-weight-medium" href="http://localhost/skydash/index.php">Back to home</a>
                            </div>
                        </div>
                        <div class="row mt-5">
